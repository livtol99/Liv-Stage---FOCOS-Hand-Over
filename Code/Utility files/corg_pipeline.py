...
class CorgPipeline:
    def __init__(self, file_number):
        ...
        self.models = {dim: BenchmarkDimension() for dim in ['0', '1', '2'] if dim in self.df.columns}
    ...
    def fit_discover_model(self, print_output=True):
        ...
        X_d = self.df[['twitter_name','0', '1', '2']].rename(columns={'twitter_name': 'entity'})
    ...
    def plot_discover_model_3d(self):
        ...
        ax.quiver(0, 0, 0, normal[0], normal[1], normal[2],color='green')
